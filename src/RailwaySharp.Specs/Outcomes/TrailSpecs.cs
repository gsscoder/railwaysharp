...
public class TrailSpecs
{
    ...
    {
        var ok1 = Result.Succeed<int, string>(1, "ok 1");
        var ok2 = Result.Succeed<int, string>(2);
        var ok3 = Result.Succeed<int, string>(2, "ok 3");
    ...
    public void Should_propagate_fails()
    {
        var ok1 = Result.Succeed<int, string>(1, "ok 1");
        var ok2 = Result.Succeed<int, string>(2);
        var fail1 = Result.FailWith<int, string>("non ok 1");
        var fail2 = Result.FailWith<int, string>("non ok 2");
